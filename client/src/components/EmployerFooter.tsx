...
const EmployerFooter: React.FC = () => {
  ...
  const footerLinks = {
    services: [
      ...
      { label: 'Tìm kiếm ứng viên', href: '/employer/candidates' },
      { label: 'Gói dịch vụ', href: '/employer/packages' },
      { label: 'Báo cáo tuyển dụng', href: '/employer/reports' }
    ],
    tools: [
      { label: 'Đánh giá CV', href: '/employer/cv-review' },
      { label: 'Giả lập phỏng vấn', href: '/employer/interview-simulator' },
      { label: 'Công cụ sàng lọc', href: '/employer/screening-tools' },
      { label: 'Quản lý ứng viên', href: '/employer/candidate-management' }
    ],
    support: [
  ...
  const socialLinks = [
    ...
    { icon: <LinkedInIcon />, href: 'https://linkedin.com/company/ptit', label: 'LinkedIn' },
        ...
        <Box sx={{ 
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Nền tảng tuyển dụng hàng đầu dành cho các nhà tuyển dụng, 
              kết nối với hàng nghìn ứng viên chất lượng từ PTIT.
            </Typography>
